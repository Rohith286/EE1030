...
# Corrected matrix conversion function
...
# a) Compute unit vector in the direction of 6a
try:
...
# b) Compute unit vector in the direction of 2a - b
try:
...
# Function from your provided code to generate line points
def line_gen(A, B):
    len = 10
    dim = A.shape[0]
